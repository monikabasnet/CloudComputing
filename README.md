...
![Kafka Service](CA0/screenshots/systemctl%20status%20kafka.png)

The Kafka service was verified as active on the Broker VM.

## Non-Root Container

![Non-Root Container](CA0/screenshots/Nonroot%20Container.png)

The application container was verified as running with the non-root `appuser` account.

## Producer Event

![Producer Event](CA0/screenshots/Producer%20Terminal.png)

A synthetic authentication event was generated by the Producer and published to Kafka.

## Pub/Sub Validation

![Pub Sub Validation](CA0/screenshots/Pub%3ASub%20Verification.png)

Kafka Pub/Sub communication was verified between the application components.

## Brute-Force Detection

![Brute Force Detection](CA0/screenshots/Possible%20Brute%20Force.png)

Repeated failed login attempts were classified until `POSSIBLE_BRUTE_FORCE` was reached.

## REST API

![REST API](CA0/screenshots/Get%20Alerts.png)

The `/alerts` REST endpoint was successfully used to retrieve stored security alerts.
